...
abstract class AbstractColumnFamily
{
     ...
     *
     * @param Connection\ConnectionPool $pool the pool to use when
     *        querying Cassandra
     ...
     * @param ConsistencyLevel|int $read_consistency_level the default consistency
     *        level for read operations on this column family
     * @param ConsistencyLevel|int $write_consistency_level the default consistency
     ...
     * @param ColumnSlice $column_slice a slice of columns to fetch, or null
    ...
    /** @internal
     * @param $value
     * @param bool $is_supercol_name
     * @param int $slice_end
     * @param bool $handle_serialize
     * @return mixed
     */
    ...
    /********************* Helper functions ************************
     * @param $read_consistency_level
     * @return ConsistencyLevel|int
     */
     ...
     * @param ColumnSlice $column_slice a slice of columns to count, or null
     ...
     *        that buffer in number of rows.
     *
     * @return Iterator\RangeColumnFamilyIterator
     */
     ...
     *
     * @param Index\IndexClause $index_clause limits the keys that are returned based
     ...
     * @param null $column_slice
     * @param mixed[] $column_names limit the columns or super columns fetched to this list
     * number of nodes that must respond before the operation returns
     *
     * @param null $consistency_level
     * @param null $buffer_size
     * @return IndexedColumnFamilyIterator
     * @throws InvalidRequestException
     * @internal param a $ColumnSlice slice of columns to fetch, or null
     */
    ...
    /**
     * Create a new Batch\CfMutator instance targetting this column
     * family.
     *
     * @param ConsistencyLevel $consistency_level the consistency
     *        level the batch mutator will write at; if left as NULL, this
     *        defaults to ColumnFamily::write_consistency_level.
     * @return CfMutator a Batch\CfMutator instance
     */
